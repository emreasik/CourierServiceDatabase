...
CREATE TABLE tblDuzenlenmisCalisan
(
	Id INT IDENTITY(1,1) PRIMARY KEY,
	Ad VARCHAR(50) NOT NULL,
	Soyad VARCHAR(50) NOT NULL,
	EskiMail VARCHAR(100) NULL CONSTRAINT check_EskiMailMusteri Check (EskiMail Like '%@%.%'),
	EskiTelno VARCHAR(16) NULL CONSTRAINT check_EskiTelMusteri Check (EskiTelno Like '[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
	TC VARCHAR(11) NOT NULL CONSTRAINT check_TCMusteri Check (TC Like '[1-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9]'),
