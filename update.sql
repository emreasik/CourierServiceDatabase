...
--ONUR CELİK ADLI KULLANICININ MAIL ADRES UPDATE
UPDATE tblMusteri
SET Mail = 'onrclk1391@hotmail.com'
WHERE TC = '63054879258'


--531119401 KODLU SUBENIN TELEFON NUMARASI DEGISTIRILDI
UPDATE tblSube
SET Telno = '8509151905'
WHERE Sube_Kodu = '531119401'

--STANDART KARGO TASIMASININ FIYATLANDIRMASI DEGISTI
UPDATE tblUrunKategorisi
SET Desi_Fiyat = 2, Kg_Fiyat = 15
WHERE Kategori_Tipi = 'STANDART'


-- SEO53211607 BARKODUN GERI DONUTUNDE MUSTERI DEGISIKLIK YAPTI
UPDATE tblGeridonut
SET Icerik = 'Ürün kutusunda hasar vardı'
WHERE MusteriId = (
SELECT TK.TeslimAlanMusteriId FROM tblKargo TK
	WHERE TK.Barkod_Numarası = 'SEO53211607'
) AND ID = (SELECT TK.GeriDonutID FROM tblKargo TK
			WHERE TK.Barkod_Numarası = 'SEO53211607')

-- 63014339114 TC'YE SAHIP PERSONEL IHTIYAC SEBEBIYLE BASKA SUBEYE AKTARILDI
UPDATE tblCalisan
...
-- ADRESINI YANLIS GOREN 36574124785 TC NOLU MUSTERI DUZELTME YAPTI
UPDATE tblAdres
